...
const details = () => ({
  id: 'Tdarr_Plugin_DTPF_Deathproof_FFMPEG_QSV_HEVC',
  Stage: 'Pre-processing',
  Name: 'Deathproof-Transcode using QSV GPU & FFMPEG',
  Type: 'Video',
  Operation: 'Transcode',
  ...
  Inputs: [
    ...
    },
    {
      ...
      type: 'string',
      defaultValue: '-low_power 1 -g:v 120 -bf 4 -extbrc 1 -rdo 1 -mbbrc 1 -b_strategy 1 -adaptive_i 1 -adaptive_b 1',
      inputUI: {
        type: 'text',
      },
      tooltip: `\\n
...
const plugin = (file, librarySettings, inputs, otherArguments) => {
  ...
  if (inputs.enable_10bit === true) {
    main10 = true;
    extraArguments += '-profile:v main10 -vf vpp_qsv=format=p010le ';
  ...
  if (main10 === false) {
    ...
    switch (file.video_codec_name) {
      case 'mpeg2':
        response.preset += '-hwaccel qsv qsv -c:v mpeg2_qsv';
        break;
      case 'h264':
